--- Determine project root, copied from https://github.com/LazyVim/LazyVim/blob/ec5981dfb1222c3bf246d9bcaa713d5cfa486fbd/lua/lazyvim/util/root.lua
---@class utils.root
---@overload fun(): string
...
function M.info()
  ...
  lines[#lines + 1] = "```"
  vim.notify(lines, { title = "LazyVim Roots" })
